...
int				handleStartGame(PLAYER, char *, char *);
int				handleLogOut(PLAYER, char *, char *);
int				handleAttackCastle(PLAYER, char *, char *);
int				handleAttackMine(PLAYER, char *, char *);
int				handleBuyWeapon(PLAYER, char *, char *);
int				handleBuyWall(PLAYER, char *, char *);
