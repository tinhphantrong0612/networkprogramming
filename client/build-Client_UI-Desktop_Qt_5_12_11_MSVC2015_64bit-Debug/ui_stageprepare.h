...
"}"));
    ...
    void retranslateUi(QMainWindow *StagePrepare)
    {
        ...
        labelNotice->setText(QApplication::translate("StagePrepare", "NOTICE: LOBBY HAS BEEN UPDATED !", nullptr));
