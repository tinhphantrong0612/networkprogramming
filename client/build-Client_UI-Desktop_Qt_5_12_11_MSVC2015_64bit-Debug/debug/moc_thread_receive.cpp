...
#include "../../Client_UI/thread_receive.h"
...
void Thread_Receive::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Thread_Receive *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send((*reinterpret_cast< char*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Thread_Receive::*)(char * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread_Receive::send)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Thread_Receive::send(char * _t1)
{
